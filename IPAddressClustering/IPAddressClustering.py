...
# PROBLEM: Given a list of IP addresses and a threshold T between 1 and 100,
# group all the IP addresses into the smallest (i.e., longest CIDR prefix) 
# non-overlapping subnets that each account for at least T% of total traffic.

# INPUT: file with IP addresses and T
# OUTPUT: list of subnets and corresponding traffics
...
# $python IPAddressClustering.py config_file_path T    
